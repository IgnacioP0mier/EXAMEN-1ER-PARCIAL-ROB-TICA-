...
enum
{
  custom_interface__srv__AddThreeInts_Event__request__MAX_SIZE = 1
};
// response
enum
{
  custom_interface__srv__AddThreeInts_Event__response__MAX_SIZE = 1
};

/// Struct defined in srv/AddThreeInts in the package custom_interface.
typedef struct custom_interface__srv__AddThreeInts_Event
{
  service_msgs__msg__ServiceEventInfo info;
  custom_interface__srv__AddThreeInts_Request__Sequence request;
  custom_interface__srv__AddThreeInts_Response__Sequence response;
} custom_interface__srv__AddThreeInts_Event;

// Struct for a sequence of custom_interface__srv__AddThreeInts_Event.
typedef struct custom_interface__srv__AddThreeInts_Event__Sequence
{
