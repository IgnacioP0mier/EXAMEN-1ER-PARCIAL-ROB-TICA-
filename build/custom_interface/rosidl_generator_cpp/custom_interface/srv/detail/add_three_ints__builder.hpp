...
{
public:
  explicit Init_AddThreeInts_Event_response(::custom_interface::srv::AddThreeInts_Event & msg)
  : msg_(msg)
  {}
  ::custom_interface::srv::AddThreeInts_Event response(::custom_interface::srv::AddThreeInts_Event::_response_type arg)
  {
...
private:
  ::custom_interface::srv::AddThreeInts_Event msg_;
};

class Init_AddThreeInts_Event_request
{
public:
  explicit Init_AddThreeInts_Event_request(::custom_interface::srv::AddThreeInts_Event & msg)
  : msg_(msg)
  {}
  Init_AddThreeInts_Event_response request(::custom_interface::srv::AddThreeInts_Event::_request_type arg)
  {
...
public:
  ...
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_AddThreeInts_Event_request info(::custom_interface::srv::AddThreeInts_Event::_info_type arg)
  {
...
template<>
inline
auto build<::custom_interface::srv::AddThreeInts_Event>()
{
  return custom_interface::srv::builder::Init_AddThreeInts_Event_info();
}
