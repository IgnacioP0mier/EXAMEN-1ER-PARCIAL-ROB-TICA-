...
class AddThreeInts_Event(metaclass=Metaclass_AddThreeInts_Event):
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<custom_interface/AddThreeInts_Request, 1>',
        'response': 'sequence<custom_interface/AddThreeInts_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['custom_interface', 'srv'], 'AddThreeInts_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['custom_interface', 'srv'], 'AddThreeInts_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from custom_interface.srv import AddThreeInts_Request
    ...
    def response(self, value):
        if self._check_fields:
            from custom_interface.srv import AddThreeInts_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
...
class AddThreeInts(metaclass=Metaclass_AddThreeInts):
    ...
    from custom_interface.srv._add_three_ints import AddThreeInts_Event as Event
