...
class GetPosition_Request(metaclass=Metaclass_GetPosition_Request):
    ...
    def th4(self, value):
        if self._check_fields:
            ...
            assert not (value < -1.7976931348623157e+308 or value > 1.7976931348623157e+308) or math.isinf(value), \
                "The 'th4' field must be a double in [-1.7976931348623157e+308, 1.7976931348623157e+308]"
        self._th4 = value
...
class Metaclass_GetPosition_Event(type):
    """Metaclass of message 'GetPosition_Event'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__get_position__event
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__get_position__event
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__get_position__event
            cls._TYPE_SUPPORT = module.type_support_msg__srv__get_position__event
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__get_position__event
...
class GetPosition_Event(metaclass=Metaclass_GetPosition_Event):
    """Message class 'GetPosition_Event'."""
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<custom_interface/GetPosition_Request, 1>',
        'response': 'sequence<custom_interface/GetPosition_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['custom_interface', 'srv'], 'GetPosition_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['custom_interface', 'srv'], 'GetPosition_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from custom_interface.srv import GetPosition_Request
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 len(value) <= 1 and
                 all(isinstance(v, GetPosition_Request) for v in value) and
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'GetPosition_Request'"
        self._request = value
    ...
    def response(self, value):
        if self._check_fields:
            from custom_interface.srv import GetPosition_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, GetPosition_Response) for v in value) and
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'GetPosition_Response'"
...
class Metaclass_GetPosition(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            if _get_position.Metaclass_GetPosition_Event._TYPE_SUPPORT is None:
                _get_position.Metaclass_GetPosition_Event.__import_type_support__()
...
class GetPosition(metaclass=Metaclass_GetPosition):
    ...
    from custom_interface.srv._get_position import GetPosition_Event as Event
